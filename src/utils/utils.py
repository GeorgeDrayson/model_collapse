...
def preprocess_and_tokenize_data(raw_datasets, tokenizer, column_names, group_texts_bool, block_size, preprocessing_num_workers, overwrite_cache, no_padding=False):

    text_column_name = "text"

    # define tokenize function
    def tokenize_function(examples):
        if group_texts_bool or no_padding:
            return tokenizer(examples[text_column_name])
        else:
            # if not grouping texts, use padding
    ...
    # group texts into block size chunks
    if group_texts_bool:
        ...
        processed_datasets = tokenized_datasets
